...
class Perusahaan extends MY_Controller {
    ...
    public function index() {
        ...
        $view_data["custom_field_headers"] = $this->Custom_fields_model->get_custom_field_headers_for_table("perusahaan", $this->login_user->is_admin, $this->login_user->user_type);
    ...
    function modal_form_edit() {
        ...
        $view_data['model_info'] = $this->Perusahaan_model->get_details($options)->row();
    ...
    function add_perusahaan() {
        ...
        $perusahaan = $this->Perusahaan_model->save($user_data);
    ...
    function list_data() {
        ...
        $list_data = $this->Perusahaan_model->get_details()->result();
        $result = array();
    ...
    function _row_data($id) {
        $custom_fields = $this->Custom_fields_model->get_available_fields_for_table("master_perusahaan", $this->login_user->is_admin, $this->login_user->user_type);
        $options = array(
            "id" => $id
        );

        $data = $this->Perusahaan_model->get_details($options)->row();
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $delete_link = "";
        if ($this->login_user->is_admin) {
            $delete_link = js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_perusahaan'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("perusahaan/delete"), "data-action" => "delete-confirmation"));
        }

        $row_data[] = modal_anchor(get_uri("perusahaan/modal_form_edit"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_perusahaan'), "data-post-id" => $data->id)).$delete_link;
    ...
    function delete() {
        ...
        if ($id != $this->login_user->id && $this->Perusahaan_model->delete($id)) {

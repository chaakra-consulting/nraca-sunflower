...
class Expenses extends MY_Controller {
    ...
    function modal_form_detail_edit() {
        ...
        // print_r($view_data['model_info']->bukti);
        // exit;
    ...
    function save_detail() {
        ...
        if (!empty($foto['name'])) { // Periksa apakah ada file yang diunggah
            ...
            $existing = $this->Expenses_model->get_details(["id" => $customers_id])->row();
            $foto = $existing ? $existing->bukti : null;
        }
    ...
    private function _make_row_entry($data) {
        ...
        $row_data = array(
            ...
            $data->bukti ? "<a href='" . base_url('assets/images/bukti/' . $data->bukti) . "' target='_blank' style='text-decoration: underline;'>Lihat File</a>" : "-",
            $data->description,

 ...
 -->   <div class="tab-content mt15">
        <div role="tabpanel" class="tab-pane active" id="general-info-tab">
            ...
            <?php if ($data['jenis_entry'] == 'Penjualan Kamar'): ?>
                <div class="form-group">
                    <label for="metode_pembayaran" class=" col-md-3">Metode Pembayaran</label>
                    <div class=" col-md-9">
                        <?php
                        echo form_dropdown("metode_pembayaran", 
                        array(
                            "" => "-",
                            "Cash" => "Cash",
                            "Prepaid" => "Prepaid",
                        ...
                        $model_info->metode_pembayaran, 
                        "class='select2 validate-hidden' id='metode_pembayaran'");
                        ?>
                    </div>
                </div>
            <?php endif; ?>            

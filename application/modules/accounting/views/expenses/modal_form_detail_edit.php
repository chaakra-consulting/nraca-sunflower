            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <div id="preview-container" class="mt-2">
                        <?php if (!empty($model_info->bukti)): ?>
                            <?php
                            $ext = pathinfo($model_info->bukti, PATHINFO_EXTENSION);
                            $is_image = in_array(strtolower($ext), ['jpg', 'jpeg', 'png', 'gif', 'webp']);
                            ?>
                            <?php if ($is_image): ?>
                                <img id="preview-image" src="<?php echo $model_info->bukti; ?>" alt="Bukti" style="max-width: 75%; height: 400px; border:1px solid #ccc; padding:5px;">
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                </div>

...
<div class="modal-body clearfix">
    ...
    <input type="hidden" name="fid_vendor" value="<?php echo $model_info->fid_vendor; ?>" />
    <input type="hidden" name="fid_cust" value="<?php echo $model_info->fid_cust; ?>" />
    <input type="hidden" name="fid_custt" value="<?php echo $model_info->fid_custt; ?>" />
    ...
    <div class="form-group">
        <label for="voucher" class=" col-md-3">VOUCHER CODE  <p style="color:red"> isi code sesuai vendors !</p></label>
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "voucher",
                "name" => "voucher",
                "value"=> "PAY-.../000/".date("m")."/".date('Y'),
...
<?php } ?>
     <div class="form-group">
        <label for="residual" class="col-md-3">Kurang Bayar</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "residual",

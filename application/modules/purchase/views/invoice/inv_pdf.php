<div style=" margin: auto;">
    <center><span style="font-size:16px;font-weight: bold;"><u>Pengeluaran Kantor</u><br><?php echo $invoice_info->code; ?></span></center><br><br>
    <?php
...
<table style="width: 100%; color: #444;">            
    ...
    foreach ($invoice_items as $item) { 
        ...
        <tr style="background-color: #f4f4f4; ">
            ...
            <td style="text-align: center; width: 15%; border: 1px solid #fff;"> <?php echo $item->quantity; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff;"> <?php echo to_currency($item->basic_price ); ?></td>

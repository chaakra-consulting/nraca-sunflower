...
<table  class="table table-bordered" id="table-print" style="">
    <tr>
        <th colspan="<?php echo (($loop-$month)+3)?>"><p style="text-align:center; font-size: 15pt; font-weight: bold;"> Laporan Laba Rugi</p>
</th>
<tr><td colspan="<?php echo (($loop-$month)+3)?>"><b>Penjualan</b> </td></tr>
	...
	<tr style="background: lightgrey">
		...
		<td class="h_kanan"><b><?php $jml_p = $jml_dapat;
...
<tr><td colspan="<?php echo (($loop-$month)+2)?>"><b>Biaya dan Beban</b></td></tr>
			...
			// for ($i=($month-1); $i <$loop ;$i++) {
				...
				if(strlen($row->account_number)==4){
					echo '<td class="h_kanan"><b>'.number_format(nsi_round($jumlah_beban), 0, 0, '.').'</b></td>';
						$jml_beban_operasional += $jumlah_beban;
					}else{
	...
	<tr style="background: lightgrey">
		...
		<?php for ($i=($month-1); $i <$loop ;$i++) {?>
		<td class="h_kanan"><b><?php $jml_p = $jml_beban_operasional;
		echo number_format(nsi_round($jml_p), 0, 0, '.')   ?></b></td>
	<?php } ?>
	</tr>
	<!--<tr style="background: lightgrey">
		<td colspan="2" class="h_kanan"><b>Pendapatan Operasi (Operating Profit)</b></td>
		<td class="h_kanan"><b><?php $jml_p = ($jml_dapat-$jml_beban-$jml_beban_operasional);
	...
	<tr style="background: lightgrey">
		...
		<td class="h_kanan"><b><?php $jml_p = $jml_dapat_non;
		echo number_format(nsi_round($jml_p))   ?></b></td>
	</tr>-->
...
<tr><td colspan="<?php echo (($loop-$month)+2)?>"><b>Pendapatan & Beban Non Operasional</b></td></tr>
	...
	<tr style="background: lightgrey">
		...
		<td class="h_kanan"><b><?php $jml_p = $jml_beban_non;
		echo number_format(nsi_round($jml_p), 0, 0, '.')   ?></b></td>
	</tr>
	<tr style="background: lightgrey">
		<td colspan="2" class="h_kanan"><b>Laba/Rugi Bersih Sebelum Pajak</b></td>
		<td class="h_kanan"><b><?php $jml_p = $jml_dapat-$jml_beban_operasional-$jml_beban_non;
		echo number_format(nsi_round($jml_p), 0, 0, '.')   ?></b></td>
	</tr>
	<tr style="background: lightgrey">
		<td colspan="2" class="h_kanan"><b>Pajak PPH 25 Badan</b></td>
		<td class="h_kanan"><b><?php $jml_p = ($jml_dapat-$jml_beban_operasional-$jml_beban_non)*0.25;
		echo number_format(nsi_round($jml_p), 0, 0, '.')   ?></b></td>
	</tr>
	<tr style="background: lightgrey">
		<td colspan="2" class="h_kanan"><b>Laba/Rugi Bersih Setelah Pajak</b></td>
		<td class="h_kanan"><b><?php $jml_p = ($jml_dapat-$jml_beban_operasional-$jml_beban_non)-(($jml_dapat-$jml_beban_operasional-$jml_beban_non)*0.25);
		echo number_format(nsi_round($jml_p), 0, 0, '.')   ?></b></td>
	</tr>
	<!--<tr style="background: lightgrey">
		<td colspan="2" class="h_kanan"><b>Laba Kotor (Gross Profit)</b></td>
		<td class="h_kanan"><b><?php $jml_p = ($jml_dapat-$jml_beban);
		echo number_format(nsi_round($jml_p))   ?></b></td>
	</tr>
	<tr style="background: lightgrey">
		<td colspan="2" class="h_kanan"><b>Net Profit</b></td>
		<td class="h_kanan"><b><?php $jml_p = ($jml_dapat+$jml_dapat_non)-$jml_beban-$jml_beban_operasional-$jml_beban_non;
		echo number_format(nsi_round($jml_p), 0, 0, '.')   ?></b></td>
	</tr>-->
</table>

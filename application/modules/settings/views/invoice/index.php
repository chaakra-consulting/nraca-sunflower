    ...
    <div class="col-sm-9 col-lg-10">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="invoice_footer2" class=" col-md-2">Footer Surat Jalan</label>
                    <div class=" col-md-10">
                        <?php
                        echo form_textarea(array(
                            "id" => "invoice_footer2",
                            "name" => "invoice_footer2",
                            "value" => get_setting("invoice_footer2"),
                            "class" => "form-control"
                        ));
                        ?>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#invoice-settings-form").appForm({
            ...
            beforeAjaxSubmit: function (data) {
                $.each(data, function (index, obj) {
                    if (obj.name === "invoice_footer2") {
                        data[index]["value"] = encodeAjaxPostData(getWYSIWYGEditorHTML("#invoice_footer2"));
                    }
                });
            },
            onSuccess: function (result) {
        ...
        initWYSIWYGEditor("#invoice_footer2", {height: 100});

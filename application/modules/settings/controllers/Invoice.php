...
class Invoice extends MY_Controller {
    ...
    function save_invoice_settings() {
        $settings = array("allow_partial_invoice_payment_from_clients", "invoice_color", "invoice_footer",  "invoice_footer2", "send_bcc_to", "invoice_prefix", "invoice_style", "invoice_logo");

...
class Vendors extends MY_Controller {
    ...
    private function _make_row($data) {
        ...
        $row_data[] = modal_anchor(get_uri("master/vendors/view"), "<i class='fa fa-eye'></i>", array("class" => "view", "title" => lang('view'), "data-post-id" => $data->id)) 
        .modal_anchor(get_uri("master/vendors/modal_form_edit"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_vendor'), "data-post-id" => $data->id)).$delete_link;

<?php echo form_open(get_uri("master/aruskas/save"), array("id" => "kas-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <?php
            echo form_dropdown("code_kas", $kode_dropdown, $model_info->code_kas, "class='select2' id='code_kas' "); 
            ?>
        </div>
    </div>
    <div class="form-group">

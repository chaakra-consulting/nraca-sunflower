<?php echo form_open(get_uri("master/assets/save"), array("id" => "asset-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <select name="tahun" id="tahun" class="form-control">
                <?php for ($i = 20; $i < 40; $i++) : ?>
                    <option <?= ($model_info->tahun == "20" . $i ? "selected" : ""); ?> value="20<?= $i; ?>">20<?= $i; ?></option>
                <?php endfor; ?>
            </select>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class=" col-md-9">
            <select name="jenis" id="jenis-asset" class="form-control jenis-assets" required>
                ...
                <option <?= ($model_info->jenis == "Elektronik" ? "selected" : ""); ?> value="Elektronik">Elektronik</option>
                <option <?= ($model_info->jenis == "Laptop" ? "selected" : ""); ?> value="Laptop">Laptop</option>
                <option <?= ($model_info->jenis == "Surat" ? "selected" : ""); ?> value="Surat">Surat</option>
                <option <?= ($model_info->jenis == "Furnitur" ? "selected" : ""); ?> value="Furnitur">Furnitur</option>
                <option <?= ($model_info->jenis == "Alat Kantor" ? "selected" : ""); ?> value="Alat Kantor">Alat Kantor</option>
            </select>
        </div>
    </div>
    <div class="form-group">
        <label for="spesifikasi" class="col-md-3">Spesifikasi dan Merk</label>
        <div class=" col-md-9">
            <?php
            echo form_textarea(array(
                "id" => "spesifikasi",
                "name" => "spesifikasi",
                "value" => $model_info->spesifikasi,
                "class" => "form-control",
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input type="number" class="form-control harga-awals" name="harga_awal" id="harga-awal" value="<?= $model_info->harga_awal; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="depresiasi" class="col-md-3">Depresiasi <small class="text-danger">(Otomatis akan di hasilkan)</small></label>
        <div class="col-md-9">
            <input type="text" class="form-control depresiasis" id="depresiasi" name="depresiasi" data-rule-required="true" data-msg-required="<?= lang("field_required"); ?>" value="<?= $model_info->depresiasi; ?>" readonly required>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input type="text" class="form-control harga-akhirs" name="harga_akhir" id="harga-akhir" data-rule-required="true" data-msg-required="<?= lang("field_required"); ?>" value="<?= $model_info->harga_akhir; ?>" readonly required>
        </div>
    </div>
    <div class="form-group">

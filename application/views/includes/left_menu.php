    ...
    <div id="sidebar-scroll">
        ...
        <ul class="" id="sidebar-menu">
            ...
            if ($is_admin || $user_type == 'manager' || $user_type == "admin_lap" || $user_type == "admin_kan" || $user_type == "verifikasi" || $user_type == "manajer_keu") {
                ...
                $al_submenu = array();
                $al_submenu[] = array("name" => "Pembelian", "slug" => "dashboard", "url" => "dashboard?stack=pembelian");
                $al_submenu[] = array("name" => "Penjualan", "slug" => "dashboard/index2", "url" => "dashboard?stack=penjualan");
                $al_submenu[] = array("name" => "Laba Rugi", "slug" => "dashboard/index2", "url" => "dashboard?stack=labarugi");
            
                $sidebar_menu[] = array("name" => "Dashboard", "slug" => "#", "url" => "#", "class" => "fa-dashboard", "submenu" => $al_submenu);

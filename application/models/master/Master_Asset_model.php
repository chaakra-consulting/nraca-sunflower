...
class Master_Asset_model extends Crud_model {
    ...
    function get_details($options = array()){
        ...
        $data = $this->db->query("SELECT * FROM tb_asset WHERE  deleted = 0  ".$where." ORDER BY id DESC");
        return $data;
    }
    ...
    function get_detailss($kas = array()){
        ...
        $end_date=get_array_value($kas, "end_date");
           ...
           $data = $this->db->query("SELECT * FROM asset WHERE  deleted = 0  ".$where." ORDER BY id DESC");
           return $data;
       }
